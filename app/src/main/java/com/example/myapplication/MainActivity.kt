...
import com.example.paymentcheck.PaymentBottomSheet.Companion.userData
...
//    private lateinit var coordinator: GooglePayFlowCoordinator
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userData = hashMapOf(
            "id" to "ps_36YNsnSlzpQR0j1TaO7f3xl96CM",
            ...
            "paymentSessionSecret" to "pss_15b0300c-2442-4af0-b16e-23eb4618a90c",
...
//        paymentLauncher.launch(intent)
        ...
        val sheet = PaymentBottomSheet(userData) { paymentId ->
